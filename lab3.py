...
# You should get an accuracy around 70%. If you wish, you can compare this with using pure decision trees or a boosted bayes classifier. 
# Not too bad, now let's try and classify a face as belonging to one of 40 persons!
def extra():
